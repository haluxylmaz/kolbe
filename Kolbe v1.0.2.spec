...
"""
PyInstaller onedir spec for Kolbe v1.0.2 (Windows) — project-root copy.

ALWAYS build with: .\\.venv\\Scripts\\python.exe -m PyInstaller ...
...
RTHOOK_HIDAPI = os.path.join(PROJECT_ROOT, "packaging", "rthooks", "pyi_rth_hidapi_path.py")
...
exe = EXE(
    ...
    a.scripts,
    [],
    exclude_binaries=True,  # klasör modu (onedir); onefile değil
    onefile=False,
    name=APP_NAME,
    debug=False,
